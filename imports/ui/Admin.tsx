	...
	public render () {
		return (
			<div key='adminActivitiesList' style={ { overflow: 'auto' } }>
				...
				<Link to='/hosts/videos' style={ { clear: 'both', float: 'left', width: '100%' } }>Download Videos</Link>
				...
				<Link to='/manage/awards' style={ { clear: 'both', float: 'left', width: '100%' } }>Manage Awards</Link>
			</div>
		)
	}
}
