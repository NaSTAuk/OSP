...
export const DEFAULT_CATEGORIES: Category[] = [
	...
	},
	{
		...
		description:
			'A showreel demonstrating the on-screen skills, styles and techniques of aparticular individual in any production excluding fictional content. This showreel may be made up of content from multiple productions.',
		forAwards: DEFAULT_AWARDS_NAMES.NASTA,
	},
	{
		...
		supportingEvidence: [
			{
				...
				maxLength: 10 * MINUTE,
				description:
					'A video submission demonstrating the achievements of your station’s marketing recognising how your station recruited members and built audiences across your campus and online, incorporating special events, advertising, social media and on-air branding and idents.',
			},
			{
				_id: Random.id(),
				type: SupportingEvidenceType.PDF,
	...
	},
	{
		...
		supportingEvidence: [
			...
			},
			{
				...
				maxLength: 100,
				description:
					'Written entry limit of 100 words, not judged but allowed to help judge how well the entry introduces the program. This is supplementary evidence and not judged in itself.',
			},
		],
		description:
			'The introductory sequence to one of your station’s programmes. The very beginning of an exemplar programme may be included. This entry must be a complete video not a cut down video or an edited highlights reel.',
		forAwards: DEFAULT_AWARDS_NAMES.NASTA,
	},
	{
		...
		description:
			'A single programme or series episode that aims to make the viewer laugh, including, but not limited to: Sitcoms, Comedy Dramas, Stand-up, SketchShows.',
		forAwards: DEFAULT_AWARDS_NAMES.NASTA,
	},
	{
		...
		description:
			'A single programme (or a shortened edit from an episode or series) oforiginal scripted dramatic production. Note: Sitcoms or dramatic productions which are primarily comedic should be entered for the Comedy category.',
		forAwards: DEFAULT_AWARDS_NAMES.NASTA,
	},
	{
	...
	},
	{
		...
		description:
			'A single programme (or a shortened edit from an episode or series) showreel demonstrating innovative content. This can be an innovative show format, innovation in the use of features or segments, or innovative ways of engaging with your audience.',
		forAwards: DEFAULT_AWARDS_NAMES.PEOPLES_CHOICE,
	},
	{
		...
		supportingEvidence: [
			{
				...
				maxLength: '500 Words',
				description:
					'A report which gives an account of any technical innovation developed to support your station’s output. Entries will demonstrate both the technical challenges faced, the innovative way(s) in which they were overcome, and the benefits this brought to the production(s).',
			},
		],
		description:
			'It is expected that entries for this award demonstrate some technical development by your station, either in software (including online) or hardware, rather than use of existing technical solutions.',
		forAwards: DEFAULT_AWARDS_NAMES.PEOPLES_CHOICE,
	},
	{
		...
		description:
			'A single programme (or a shortened edit from an episode or series) showcasing excellence in the following areas: cinematography, editing, animations and visual effects.',
		forAwards: DEFAULT_AWARDS_NAMES.PEOPLES_CHOICE,
	},
	{
